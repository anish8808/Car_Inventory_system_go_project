...
func NewParkingLot(slots []*model.Slot, entrances []*model.Entrance, strategy model.CostStrategy) *ParkingLot {
	return &ParkingLot{
		Slots:        slots,
		Entrances:    entrances,
...
func (p *ParkingLot) FindNearestAvailableSlot(vehicleType model.VehicleType, entrance *model.Entrance) (*model.Slot, error) {
